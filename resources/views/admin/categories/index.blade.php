...
<div class="container">
  ...
  @component('admin.categories.breadcrumb')
  ...
  <a href="http://mysite/admin/category/create" class="btn btn-primary pull-right"><i class="fa fa-plus-square-o"></i> Создать категорию</a>
